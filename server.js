...
import backup from './server/routes/backup/backup.js';
...
io.on('connection', (socket) => {
  ...
  socket.on('client:cDelivery', (info) => {
    socket.broadcast.emit('server:cDelivery', info);
  });

  socket.on('client:change-cod', (info) => {
